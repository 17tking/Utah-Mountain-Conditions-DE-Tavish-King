...
dly_sunset_utc TIMESTAMPTZ,
dly_sunrise_utc TIMESTAMPTZ,
dly_rain_sum_mm NUMERIC(5,2),
dly_showers_sum_mm NUMERIC(5,2),
dly_snowfall_sum_cm NUMERIC(5,2),
dly_uv_index_max NUMERIC(5,2),
dly_weather_code INT, --NEED TO MAKE WEATHER CODE TABLE
dly_visibility_max_m NUMERIC(5,2),
dly_visibility_min_m NUMERIC(5,2),
dly_cloud_cover_max_pct INT,
dly_cloud_cover_min_pct INT,
dly_visibility_mean_m NUMERIC(5,2),
dly_cloud_cover_mean_pct INT,
dly_dew_point_2m_max_celsius NUMERIC(5,2),
dly_dew_point_2m_min_celsius NUMERIC(5,2),
dly_daylight_duration_seconds NUMERIC(5,2),
dly_dew_point_2m_mean_celsius NUMERIC(5,2),
dly_precipitation_sum_mm NUMERIC(5,2),
dly_sunshine_duration_seconds NUMERIC(5,2),
dly_temperature_2m_max_celsius NUMERIC(5,2),
dly_temperature_2m_min_celsius NUMERIC(5,2),
dly_wind_gusts_10m_max_kmh NUMERIC(5,2),
dly_wind_gusts_10m_min_kmh NUMERIC(5,2),
dly_wind_speed_10m_max_kmh NUMERIC(5,2),
dly_wind_speed_10m_min_kmh NUMERIC(5,2),
dly_precipitation_hours NUMERIC(5,2),
dly_temperature_2m_mean_celsius NUMERIC(5,2),
dly_wind_gusts_10m_mean_kmh NUMERIC(5,2),
dly_wind_speed_10m_mean_kmh NUMERIC(5,2),
dly_surface_pressure_max_hpa NUMERIC(5,2),
dly_surface_pressure_min_hpa NUMERIC(5,2),
dly_surface_pressure_mean_hpa NUMERIC(5,2),
dly_apparent_temperature_max_celsius NUMERIC(5,2),
dly_apparent_temperature_min_celsius NUMERIC(5,2),
dly_relative_humidity_2m_max_pct INT,
dly_relative_humidity_2m_min_pct INT,
dly_apparent_temperature_mean_celsius NUMERIC(5,2),
dly_relative_humidity_2m_mean_pct INT,
dly_wind_dir_10m_dominant INT,
dly_precipitation_probability_max_pct INT,
dly_precipitation_probability_min_pct INT,
dly_precipitation_probability_mean_pct INT,
PRIMARY KEY(mtn_id, dly_time_utc)
);
