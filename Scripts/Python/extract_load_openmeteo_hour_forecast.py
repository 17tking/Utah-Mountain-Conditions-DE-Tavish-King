...
def main():
    ...
    base_params = {
        ...
        "hourly": [
            ...
            "snow_depth", "weather_code", "surface_pressure", "cloud_cover", "visibility",
            "wind_speed_10m", "wind_speed_80m", "wind_direction_10m", "wind_direction_80m",
            "wind_gusts_10m", "uv_index", "is_day", "sunshine_duration", "freezing_level_height"
        ],
        "models": "best_match",
        "timezone": "auto",
        "forecast_days": 1
    ...
    try:
        ...
        conn.rollback()
        print("=" * 50)
        print("ERROR OCCURRED DURING HOURLY FORECAST INSERT")
